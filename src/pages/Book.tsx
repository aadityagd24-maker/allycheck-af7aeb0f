  ...
  return (
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      <Helmet>
        ...
        <meta name="description" content="Book a free 20-minute call with a senior accessibility auditor to assess your EAA exposure." />
      </Helmet>
      <Nav />
        ...
        <div className="container-x grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3">
            ...
            <p className="mt-6" style={{ color: "var(--ink-secondary)", fontSize: "1.1rem", maxWidth: "520px" }}>
              Book a free 20-minute call with a senior auditor. No sales pitch — just an honest assessment of where your product stands before your next enterprise procurement review.
            </p>
