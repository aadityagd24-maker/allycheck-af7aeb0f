...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "AllyCheck — Manual Accessibility Audits & VPAT Certification" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "AllyCheck — Manual Accessibility Audits & VPAT Certification" },
      {
        property: "og:description",
        content:
          "Stop losing enterprise deals to accessibility flags. Human-led WCAG 2.1 AA audits, VPAT 2.4 reports, and developer-ready remediation.",
      },
    ],
  }),
});
      ...
      <div className="container-x grid lg:grid-cols-2 gap-16 items-center py-24">
        <div>
          ...
          <p
            ...
            style={{ fontSize: "0.8rem", color: "var(--ink-secondary)", animationDelay: "480ms" }}
          >
      ...
      <div className="container-x">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="h2 mt-5">
            Overlays Don't Pass Audits.<br/>Manual Experts Do.
          </h2>
        </div>
          ...
          <div style={{ borderLeft: "3px solid var(--accent)", paddingLeft: "2rem" }}>
            ...
            <ul className="mt-6 space-y-2.5">
              {[
                ...
                "VPAT 2.4 (ITPC format)",
                "Assistive technology testing",
                "Named auditor, not an algorithm",
  ...
  const cards = [
    {
      ...
      b: "A page-by-page review of your SaaS product by a certified human auditor. We test keyboard navigation, screen reader compatibility, colour contrast, focus management, and 50+ WCAG 2.1 success criteria. You receive a detailed findings report — not a spreadsheet, a proper document.",
    },
    {
      n: "02",
      t: "VPAT Certification Report",
      b: "A Voluntary Product Accessibility Template (VPAT 2.4) is the only document enterprise procurement, government buyers, and legal departments accept as proof of accessibility compliance. We author it. We stand behind it. It carries AllyCheck's named certification.",
    },
    {
      n: "03",
      t: "Developer Remediation Roadmap",
      b: "Compliance paperwork means nothing if your product still breaks. Every audit includes a prioritised, developer-ready remediation guide — ordered by severity, written in plain language, with code-level guidance your engineers can execute in their next sprint.",
    },
  ];
  return (
  ...
  const steps = [
    {
      n: "1",
      t: "Scope & Discovery",
      b: "We begin with a 30-minute briefing call to understand your product, your target markets, and your compliance deadlines. We agree the scope — pages, user flows, assistive technology targets — and issue a fixed-price proposal within 24 hours.",
    },
    {
      n: "2",
      t: "Manual Audit",
      b: "Our certified auditors test your product against WCAG 2.1 AA criteria using real assistive technologies. The audit takes 5–10 business days depending on scope. You are kept informed throughout — no black box.",
    },
    {
      n: "3",
      t: "Report & Certification",
      b: "You receive a full findings report, a signed VPAT 2.4 document, and a developer remediation roadmap. Your documentation is ready to share with procurement teams, legal departments, and enterprise buyers immediately.",
    },
  ];
  return (
      ...
      <div className="container-x">
        ...
        <div className="mt-16 relative grid md:grid-cols-3 gap-12">
          <div
            ...
            style={{ top: "2.5rem", left: "8%", right: "8%", height: "1px", background: "var(--rule)" }}
            aria-hidden
          />
          {steps.map((s) => (
            <div key={s.n} className="relative" style={{ background: "var(--surface)" }}>
              ...
              <h3 className="h3 mt-4">{s.t.replace(/^\d\.\s*/, "")}</h3>
  ...
  return (
    <footer style={{ background: "var(--surface)", borderTop: "1px solid var(--rule)" }}>
      ...
      <div style={{ borderTop: "1px solid var(--rule)" }}>
        <div
          className="container-x py-6 flex flex-wrap justify-between gap-3"
